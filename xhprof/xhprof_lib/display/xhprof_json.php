...
/*
 *  M O D I F I E D / D E R I V E D
 *
 * Copyright (c) 2010 Zynga
 *
 * Derived from xhprof.php to provide a json source to YUI datatables.
 *
 */
...
function xhprof_include_js_css($ui_dir_url_path = null) {
  ...
  echo "<link href='$ui_dir_url_path/css/xhprof.css' rel='stylesheet' ".
    " type='text/css'></link>";
  echo "<link href='http://yui.yahooapis.com/2.9.0/build/datatable/assets/skins/sam/datatable.css' rel='stylesheet' "."type='text/css'></link>";
  ...
  echo "<link href='$ui_dir_url_path/jquery/jquery.autocomplete.css' ".
    " rel='stylesheet' type='text/css'></link>";
  echo "<link rel='stylesheet' type='text/css' href='http://yui.yahooapis.com/3.3.0/build/cssbase/base-context-min.css'>";
  echo "<link href='$ui_dir_url_path/css/xhprof_yui.css' rel='stylesheet' ".
    " type='text/css'></link>";  
  echo "<link type='text/css' href='http://jqueryui.com/themes/base/jquery.ui.all.css' rel='stylesheet'/>"; 
  echo "<link type='text/css' href='http://jqueryui.com/demos/demos.css' rel='stylesheet'/>"; 
  echo "<link type='text/css' href='$ui_dir_url_path/css/datatablegrouper.css' rel='stylesheet'/>"; 
// javascript
 echo "<script src= 'http://jqueryui.com/jquery-1.5.1.js' charset='utf-8'></script>";
...
//  echo "<script src='$ui_dir_url_path/jquery/jquery-1.2.6.js'>".
 ...
 echo "<script src= 'http://jqueryui.com/ui/jquery.ui.core.js' charset='utf-8'></script>";
 echo "<script src= 'http://jqueryui.com/ui/jquery.ui.widget.js' charset='utf-8'></script>";
 echo "<script src= 'http://jqueryui.com/ui/jquery.ui.button.js' charset='utf-8'></script>";
 echo "<script src= 'http://jqueryui.com/ui/jquery.ui.dialog.js' charset='utf-8'></script>";
echo'<script type="text/javascript" src="http://yui.yahooapis.com/2.8.0/build/yahoo-dom-event/yahoo-dom-event.js"></script>';
		echo'<script type="text/javascript" src="http://yui.yahooapis.com/2.8.0/build/dragdrop/dragdrop-min.js"></script>';
		echo'<script type="text/javascript" src="http://yui.yahooapis.com/2.8.0/build/element/element-min.js"></script>';
		echo'<script type="text/javascript" src="http://yui.yahooapis.com/2.8.0/build/datasource/datasource-min.js"></script>';
		echo'<script type="text/javascript" src="http://yui.yahooapis.com/2.8.0/build/datatable/datatable-min.js"></script>';
		echo'<script type="text/javascript" src="http://yui.yahooapis.com/2.8.0/build/logger/logger-min.js"></script>';
		 echo "<script src= '$ui_dir_url_path/js/groupdatatable.js' charset='utf-8'></script>";

 // echo "<script src= '' charset='utf-8'></script>";
...
if(isset($_GET['count'])) {
	$top_results = array_chunk($flat_data,$_GET['count']);
	$top_response['posts'] =$top_results[0];
	$top_response['totals'] = $totals;
	echo json_encode($top_response);
}
else{
...
function symbol_report($url_params,
  ...
  if ($diff_mode) {
    ...
    print('<table id="summary" style="border-color:grey;font-size:16px; border:1px solid ;border-color:grey; margin-left: auto; margin-right: auto;">' . "\n");
    print('<tr style="background: #D8D8DA url(http://yui.yahooapis.com/2.9.0/build/assets/skins/sam/sprite.png) repeat-x 0 0;text-align:center">');
